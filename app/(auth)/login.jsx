...
import { LinearGradient } from "expo-linear-gradient";
import { Ionicons } from "@expo/vector-icons";
import GoogleLoginBtn from "../../components/common/GoogleLoginBtn"; // <--- IMPORT ADDED
      ...
      >
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            {/* Social Login Button (Replaced dummy icons with real component) */}
            <View style={styles.socialContainer}>
              <GoogleLoginBtn role="customer" />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  // Social Buttons Container (Cleaned up for single button)
  socialContainer: {
    flexDirection: "row",
    justifyContent: "center",
    // Removed gap and complex layout since we only have one button now
  },
  // Removed unused socialButton styles since we use the component now
