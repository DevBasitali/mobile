        ...
        >
          ...
          >
            ...
            <View style={styles.formContainer}>
              ...
              {/* Social Buttons (UPDATED to use Real Google Button) */}
              <View style={styles.socialContainer}>
                {/* Passed the 'role' state so backend creates the right user type */}
...
const styles = StyleSheet.create({
  ...
  // Removed old .socialButton style since component handles it
