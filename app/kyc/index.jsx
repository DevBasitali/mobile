  ...
  const captureFromCamera = async (field) => {
    try {
      ...
      if (permission.granted === false) {
        Alert.alert(
          'Permission Required',
          'You need to allow camera access to take a selfie.'
        );
        return;
      }
      ...
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.statusContainer, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
          <View style={styles.statusIconContainer}>
            ...
            >
              <MaterialCommunityIcons name="clock-outline" size={60} color={COLORS.navy[900]} />
            </LinearGradient>
          </View>
          ...
          <View style={styles.infoCard}>
            <Ionicons name="information-circle-outline" size={24} color={COLORS.gold[500]} />
            <Text style={styles.infoText}>
              Usually takes 24-48 hours
            </Text>
          </View>

          <TouchableOpacity style={styles.primaryButton} onPress={handleSkip} activeOpacity={0.8}>
            <LinearGradient
    ...
    return (
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.statusContainer, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
          ...
          <View style={[styles.infoCard, { backgroundColor: COLORS.emerald[500] + '15' }]}>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={handleSkip} activeOpacity={0.8}>
            ...
            >
              <Text style={[styles.primaryButtonText, { color: COLORS.white }]}>Continue to App</Text>
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerIconContainer}>
            ...
            >
              <MaterialCommunityIcons name="shield-account" size={28} color={COLORS.navy[900]} />
            </LinearGradient>
          </View>
          <Text style={styles.title}>Verify Your Identity</Text>
          <Text style={styles.subtitle}>
            Upload your documents to unlock all features and start {user?.role === 'host' ? 'listing cars' : 'booking rides'}
          </Text>
        </View>
        ...
        <UploadBlock
          ...
          onRemove={() => setImages((prev) => ({ ...prev, driving_license: null }))}
        ...
        >
          <LinearGradient
            colors={uploading ? [COLORS.gray[600], COLORS.gray[600]] : [COLORS.gold[500], COLORS.gold[600]]}
            style={styles.buttonGradient}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 0 }}
          >
...
// ============================================
function UploadBlock({ label, description, image, onPress, onRemove, icon, iconType }) {
  return (
        ...
        {image ? (
          ...
          <View style={styles.placeholder}>
            <View style={styles.placeholderIconContainer}>
              <MaterialCommunityIcons name={icon} size={40} color={COLORS.gold[500]} />
            </View>
            ...
            <View style={styles.uploadTypeIndicator}>
              <Ionicons
                name={iconType === 'camera' ? 'camera-outline' : 'image-outline'}
                size={16}
